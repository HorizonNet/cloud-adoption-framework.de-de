...
In diesem Governanceleitfaden implementiert das Identitätsverwaltungsteam das Muster für die **[Verzeichnissynchronisierung](/azure/architecture/cloud-adoption/decision-guides/identity/overview#directory-synchronization)** :
...
Da keine Anforderungen bestehen, geht die IT-Sicherheit auf Nummer sicher und hat ein **[Cloud-DMZ](/azure/architecture/cloud-adoption/decision-guides/software-defined-network/cloud-dmz)** -Muster angefordert. Das bedeutet, dass die Governance der Azure-Bereitstellungen selbst sehr gering sein wird.
...
An dieser Stelle wird ein **[cloudnatives](/azure/architecture/cloud-adoption/decision-guides/encryption/overview#key-management)** Muster für die Verschlüsselung vorgeschlagen, aber von keinem Entwicklungsteam verlangt.
...
Die erste Entscheidung in Bezug auf die Beschleunigung der Bereitstellung ist das Muster für die Erzwingung. In diesem Beispiel hat sich das Governanceteam dafür entschieden, das Muster **[Automatisierte Erzwingung](/azure/architecture/cloud-adoption/decision-guides/policy-enforcement/overview#automated-enforcement)** zu implementieren.
