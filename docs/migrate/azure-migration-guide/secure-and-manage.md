...
description: Sichern und Verwalten
author: matticusau
ms.author: mlavery
ms.date: 04/04/2019
ms.topic: conceptual
...
Weitere Informationen finden Sie in der [Azure Service Health-Dokumentation](/azure/service-health).
...
[Übersicht](/azure/backup/backup-introduction-to-azure-backup)
