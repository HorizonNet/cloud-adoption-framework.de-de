...
- Wenn mehrere Instanzen ähnlicher Umgebungen bereitgestellt werden müssen, könnte eine Umgebungsfactory für Konsistenz sorgen, die Governance verbessern und die Bereitstellung beschleunigen. Die [Governance Journey für große Unternehmen](../../govern/guides/complex/index.md) etabliert eine Vorgehensweise, bei der eine Umgebungsfactory erstellt wird, die sich über mehrere Regionen hinweg skalieren lässt.
