...
Jetzt, da Contoso die geschäftlichen Triebkräfte und Migrationsziele festgelegt hat, kann es sich an der [Migrationsmethodik](../index.md) orientieren und auf der Anwendung von Migrationswellen und Migrationssprints aufbauen, um Migrationsbemühungen iterativ zu planen und durchzuführen.
...
Es gibt einige weitere Partnertools, die Contoso bei der Bewertung der lokalen Umgebung im Hinblick auf die Migration zu Azure unterstützen können. [Erfahren Sie mehr](https://azure.microsoft.com/migration/partners) über Azure-Migrationspartner.
...
Contoso plant, eine Reihe von „Lift & Shift“-Migrationen durchzuführen. Um sicherzustellen, dass dies funktioniert, repliziert Migrate immer jeweils etwa 100 VMs gleichzeitig. Contoso muss eine Kapazitätsplanung für die vorgeschlagene Migration ausführen, um herauszufinden, wie dies funktioniert.
...
- Abschließend muss das Unternehmen ermitteln, wie viele Server erforderlich sind, um die Migrate-Komponenten auszuführen, die für die Bereitstellung benötigt werden.
...
**Komponente** | **Details**
--- | ---
**Konfigurationsserver** | Normalerweise eine VMware-VM, die mithilfe einer OVF-Vorlage konfiguriert wurde.<br/><br/> Die Konfigurationsserverkomponente koordiniert die Kommunikation zwischen der lokalen Umgebung und Azure und verwaltet die Datenreplikation.
