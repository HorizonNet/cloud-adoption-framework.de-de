...
:::row:::
    :::column:::
        **Netzwerkfunktionen** <br>
        [Virtuelle Azure-Netzwerke][virtual-network] <br>
        [Netzwerksicherheitsgruppen][NSG] <br>
        [Dienstendpunkte][ServiceEndpoints] <br>
        [Private Link][PrivateLink] <br>
        [Benutzerdefinierte Routen][UDR] <br>
        [Virtuelle Netzwerkgeräte][NVA]: <br>
        [Öffentliche IP-Adressen][PIP] <br>
        [Azure DNS][DNS]
    :::column-end:::
    :::column:::
        **Lastenausgleich** <br>
    ...
    :::column:::
        **Konnektivität** <br>
        [Peering virtueller Netzwerke][virtual-network-peering] <br>
...
:::row:::
    :::column:::
        **Identität** <br>
        ...
        [Rollenbasierte Zugriffssteuerung][RBAC] <br>
        [Azure AD-Standardrollen][Roles]
    :::column-end:::
    :::column:::
        **Überwachung** <br>
    ...
    :::column:::
        **bewährten Methoden** <br>
        [Verwaltungsgruppe][MgmtGrp] <br>
        [Abonnementverwaltung](../ready/azure-best-practices/scale-subscriptions.md) <br>
        [Verwaltung von Ressourcengruppen][RGMgmt] <br>
        [Einschränkungen für Azure-Abonnements][limits]
    :::column-end:::
:::row-end:::
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        **Weitere Azure-Dienste** <br>
        [Azure Storage (in englischer Sprache)][Storage] <br>
        [Azure SQL][SQL] <br>
