...
|-|-|-|
| [Azure Firewall][AzFW] <br> [Firewall Manager][AzFWMgr] <br> [Application Gateway – WAF][AppGWWAF] <br> [Front Door – WAF][AFDWAF] <br> [Azure DDoS][DDoS] <br> | [Azure Storage (in englischer Sprache)][Storage] <br> [Azure SQL][SQL] <br> [Azure-Web-Apps][WebApps] <br> [Cosmos DB][cosmos-db] <br> [HDInsight][HDInsight] | [Event Hubs][EventHubs] <br> [Service Bus][ServiceBus] <br> [Azure IoT][IoT] <br> [Azure Machine Learning][machine-learning] |
