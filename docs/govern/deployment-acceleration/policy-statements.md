...
description: Verwenden Sie das Framework für die Cloudeinführung (Cloud Adoption Framework) für Azure, um exemplarische Richtlinienanweisungen für die Beschleunigung der Bereitstellung zu erhalten, die Sie beim Entwerfen von Richtlinienanweisungen unterstützen.
author: alexbuckgit
ms.author: abuck
ms.date: 09/17/2019
ms.topic: conceptual
