...
| Welche Optionen für bedingten Zugriff gibt es in Azure AD? | [Bedingter Zugriff auf Azure AD](/azure/active-directory/conditional-access/overview) | [Bedingter Zugriff auf Azure AD](/azure/active-directory/conditional-access/overview) | [Bedingter Zugriff auf Azure AD](/azure/active-directory/conditional-access/overview) <br><br> [AD FS-Anspruchsregeln](https://adfshelp.microsoft.com/AadTrustClaims/ClaimsGenerator) |
