...
Ihr erstes Einführungsprojekt sollte mit Ihren [Beweggründen](./motivations-why-are-we-moving-to-the-cloud.md) für die Einführung der Cloud übereinstimmen. Soweit möglich, sollte Ihr erstes Projekt auch Fortschritte in Richtung eines definierten [Geschäftsergebnisses](./business-outcomes/how-to-use-the-business-outcome-template.md) nachweisen.
...
- **Datenplattform:** Erstellen Sie einen Data Lake mit skalierbarem Compute für Analyse-, Berichterstellungs- oder Machine Learning-Workloads.
