...
Ihre erstes Cloudprojekt hilft Ihnen dabei, Beweggründe und technischen Aufwand miteinander in Einklang zu bringen. Dieser Artikel dient Ihnen als Hilfe bei der sorgfältigen Auswahl Ihres ersten Projekts.
                        </div>
                    </div>
                </div>
            </div>
...
Beginnen Sie mit der Erstellung Ihrer Cloudeinführungsstrategie, indem Sie die [Beweggründe für die Cloudeinführung dokumentieren](./motivations-why-are-we-moving-to-the-cloud.md).

> [!div class="nextstepaction"]
> [Motivationen für den Wechsel in die Cloud](./motivations-why-are-we-moving-to-the-cloud.md)
