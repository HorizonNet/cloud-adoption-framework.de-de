...
Azure Policy verfügt über eine integrierte [Richtlinieninitiative](/azure/governance/policy/overview#initiative-definition), die sowohl den Log Analytics-Agent als auch den [Microsoft Dependency-Agent](/azure/azure-monitor/insights/vminsights-onboard#the-microsoft-dependency-agent) umfasst, der für Azure Monitor für VMs benötigt wird.
