...
1. Wenden Sie [konsistente Benennung](../../../ready/considerations/name-and-tag.md) jeder Ebene dieser Gruppierungshierarchie an.

![Diagramm der Ressourcenorganisation für große Unternehmen](../../../_images/governance/large-enterprise-resource-organization.png)
...
- [Große Unternehmen: Multi-Cloud-Entwicklung](./multicloud-evolution.md)
