...
Diese Funktionen sind in Azure integriert, sie erfordern jedoch jeweils Konfigurationsanpassungen, sodass die Kosten höher ausfallen können. Die Orientierung der einzelnen cloudnativen Funktionen an einer [Strategie zur Datenklassifizierung](../policy-compliance/what-is-data-classification.md) wird dringend empfohlen.
