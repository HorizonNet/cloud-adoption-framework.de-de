...
![Der globale Azure AD-Administrator erstellt das Workloadbesitzer-Konto](../../_images/governance-1-2.png)
...
![Der Azure-Kontobesitzer erstellt ein Abonnement](../../_images/governance-1-3.png)
...
![Der Azure-Kontobesitzer ordnet den Azure AD-Mandanten dem Abonnement zu](../../_images/governance-1-4.png)
...
![Der Azure-Kontobesitzer fügt den **Workloadbesitzer** dem Abonnement hinzu](../../_images/governance-1-5.png)
...
![Der **Workloadbesitzer** erstellt eine Ressourcengruppe](../../_images/governance-1-7.png)
...
![Der **Workloadbesitzer** erstellt eine Ressource](../../_images/governance-1-8.png)
...
Nachdem das Abonnement erstellt und Ihr Azure AD-Mandant zugeordnet wurde, können Sie [den **Workloadbesitzer** dem Abonnement mit der integrierten Rolle **Besitzer** hinzufügen](/azure/billing/billing-add-change-azure-subscription-administrator#assign-a-user-as-an-administrator-of-a-subscription).
