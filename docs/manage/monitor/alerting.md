...
- [Aktivitätsprotokollwarnung](https://docs.microsoft.com/azure/azure-monitor/platform/alerts-activity-log): Warnungen zu Elementen im Aktivitätsprotokollspeicher, ausgenommen sind Service Health-Daten.
...
Beachten Sie die geltenden [Einschränkungen](https://docs.microsoft.com/azure/azure-subscription-service-limits#azure-monitor-limits) für die Anzahl von Benachrichtigungen, die erstellt werden können. Einige Grenzwerte (aber nicht alle) können auf Wunsch erhöht werden. Wenden Sie sich hierzu an den Support.
