...
- Weitere Informationen zum Schützen von Ressourcen mit Richtlinien, der rollenbasierten Zugriffssteuerung und anderen Azure-Diensten finden Sie im Artikel [Implementieren der Sicherheit für die Ressourcenverwaltung in Azure](/learn/paths/implement-resource-mgmt-security).
...
- [Überwachen von Hybrid Cloud-Netzwerken in Microsoft Azure](https://www.pluralsight.com/courses/microsoft-azure-hybrid-cloud-networks-monitoring) ist ein Kurs für Fortgeschrittene, in dem gezeigt wird, wie Sie mithilfe von Azure-Überwachungstools virtuelle Netzwerke und virtuelle private Netzwerkverbindungen für Ihre Hybrid Cloud-Implementierung visualisieren, verwalten und optimieren können.

- Der Artikel [Azure Arc für Server](/azure/azure-arc/servers/overview) enthält eine Beschreibung dazu, wie Sie Ihre außerhalb von Azure gehosteten Windows- und Linux-Computer auf ähnliche Weise wie Ihre in Azure ausgeführten VMs verwalten können.
...
- Informieren Sie sich darüber, wie [Azure Monitor](/azure/azure-monitor/overview) Ihnen das Anzeigen der Verfügbarkeit und Leistung Ihrer Anwendungen und Dienste an einem zentralen Ort ermöglicht. Von Pluralsight werden die folgenden Kurse angeboten:
  ...
  - In dem Kurs [Instrumentieren von Anwendungen mit Azure Monitor Application Insights](https://app.pluralsight.com/library/courses/microsoft-azure-application-insights-web-application-instrument) wird ausführlich beschrieben, wie Sie mit dem Application Insights SDK Telemetriedaten und Ereignisse einer Anwendung mit Angular- und Node.js-Komponenten sammeln.

  - Bei [Anwendungsdebuggen und -profilerstellung](https://www.pluralsight.com/courses/devintersection-azureai-session-31) handelt es sich um eine Aufzeichnung einer Session von einer Microsoft-Konferenz. Thema ist die Verwendung und Interpretation von Daten, die vom Momentaufnahmedebugger und Profiler von Azure Monitor Application Insights bereitgestellt werden.

<!-- docutune:ignore "from Scratch" -->

## <a name="data-analysis"></a>Datenanalyse

- Informieren Sie sich darüber, wie Sie [Protokollabfragen in Azure Monitor](/learn/modules/analyze-infrastructure-with-azure-monitor-logs/) schreiben. Die Abfragesprache „Kusto“ ist die Hauptressource für das Schreiben von Azure Monitor-Protokollabfragen, um Protokolldaten für die erfassten Daten aus Azure und die Abhängigkeiten von Hybridressourcenanwendungen (einschließlich der Liveanwendung) zu untersuchen und zu analysieren.

- [Abfragesprache „Kusto“ (Kusto Query Language, KQL) für Einsteiger](https://www.pluralsight.com/courses/kusto-query-language-kql-from-scratch) ist ein umfassender Kurs, der ausführliche Beispiele für eine große Bandbreite von Anwendungsfällen und Techniken für die Protokollanalyse in Azure Monitor-Protokollen enthält.
...
Die Hybrid Cloud-Umgebung bedeutet für die IT-Abteilung, dass nicht definierte Rollen, Zuständigkeiten und Aktivitäten bewältigt werden müssen. Organisationen müssen die Umstellung auf moderne Dienstverwaltungsverfahren vollziehen, z. B. in Bezug auf agile Methoden und DevOps-Methodiken, um die Transformations- und Optimierungsanforderungen heutiger Unternehmen schneller und effizienter erfüllen zu können.
...
Lesen Sie das [Whitepaper zu ITIL 4 und zur Cloud](https://www.axelos.com/case-studies-and-white-papers/itil-4-and-the-cloud), um sich mit den Updates vertraut zu machen, die für das beliebteste ITSM-Framework durchgeführt wurden. Darin wird beschrieben, wie die vorhandene ITIL-Anleitung mit den Best Practices für DevOps, die agile Entwicklung und Lean Management kombiniert werden kann. Informieren Sie sich auch über die [IT4IT-Referenzarchitektur](https://www.opengroup.org/it4it), bei der es sich um eine alternative Blaupause für die IT-Transformation mithilfe eines prozessagnostischen Frameworks handelt.
