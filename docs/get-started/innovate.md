...
- [Beweggründe](../strategy/motivations.md): Der erste Schritt bei der strategischen Ausrichtung besteht darin, einen Konsens hinsichtlich der Beweggründe für die Innovationsbestrebungen zu erzielen. Beginnen Sie damit, Beweggründe und gemeinsame Themen verschiedener Beteiligter aus dem Geschäfts- und IT-Bereich nachzuvollziehen und zu kategorisieren.
- [Geschäftsergebnisse](../strategy/business-outcomes/index.md): Nachdem die Beweggründe ausgerichtet wurden, können die gewünschten Geschäftsergebnisse erfasst werden. Dadurch werden klare Metriken bereitgestellt, an denen die gesamte Transformation gemessen werden kann.
...
- [Geschäftliche Begründung](../strategy/cloud-migration-business-case.md): Vor der Bewertung der einzelnen Innovationsmöglichkeiten in der Cloud sollte eine allgemeine geschäftliche Begründung erstellt werden, an der sich die Beteiligten im Zusammenhang mit dem allgemeinen Einführungsplan orientieren können.
...
- Rohdaten zum vorhandenen Bestand (Anwendungen, virtuelle Computer und Daten)
...
- [Inkrementelle Rationalisierung](../digital-estate/rationalize.md#incremental-rationalization): Optimieren Sie die Bewertung, und konzentrieren Sie sich auf eine qualitative Analyse aller Ressourcen (möglicherweise sogar zur Unterstützung des Geschäftsszenarios). Fügen Sie dann eine umfassende qualitative Analyse für die ersten zehn Workloads hinzu.
...
Wenn neue Innovationen von vorhandenen Workloads oder Ressourcen abhängig sind, bietet die Vorlage für den Cloudeinführungsplan einen beschleunigten Ansatz für die Entwicklung eines Projektbacklogs. Das Backlog kann dann geändert werden, um Ermittlungsergebnisse, Rationalisierung, Qualifizierung und Partnerverträge widerzuspiegeln.

**Ziele:**

- Stellen Sie die Backlogvorlage bereit.
- Aktualisieren Sie die Vorlage mit den ersten zehn zu migrierenden Workloads.
- Aktualisieren Sie die Personen und die Geschwindigkeit, um das Releasetiming zu schätzen.
- Risiken bei der Zeitplanung:
...
- [Vorlage für den Cloudeinführungsplan](../plan/template.md): Stellen Sie die Basisvorlage bereit.
- [Workloadausrichtung](../plan/workloads.md): Definieren Sie Workloads im Backlog.
...
- [Ausrichtung von Personen und Zeit](../plan/iteration-paths.md): Legen Sie Iteration, Geschwindigkeit (Zeitaufwand der Personen) und Releases für die Workloads fest.
...
Die folgenden Links helfen dem Einführungsteam dabei, den vom Cloudgovernanceteam verfolgten Ansatz besser zu verstehen.

- [Governanceansatz](../govern/index.md): Diese Methodik beschreibt einen Prozess für Überlegungen zu Unternehmensrichtlinien und -prozessen und den anschließenden Aufbau der Disziplinen, die erforderlich sind, um eine übergreifende Governance für die gesamten Cloudbestrebungen des Unternehmens zu gewährleisten.
...
Definieren Sie den Plan für langfristige operative Zuständigkeiten im Zusammenhang mit der geplanten Innovation. Ist die festgelegte Verwaltungsbaseline für Ihre betrieblichen Anforderungen ausreichend? Falls nicht, prüfen Sie spezifische Finanzierungsoptionen im Zusammenhang mit der Technologie, die diese Innovation unterstützt.
...
- Risiken bei der Zeitplanung:
  - Governance-, Betriebs- und Sicherheitsanforderungen für die ersten zehn Workloads können diesen Prozess erheblich verlangsamen. Die eigentliche Umgestaltung der ersten Zielzone und der nachfolgenden Zielzonen dauert erheblich länger, sollte aber parallel zu den Migrationsmaßnahmen erfolgen.
...
- [Erweitern der Zielzone](../ready/considerations/index.md): Identifizieren Sie unabhängig vom Ausgangspunkt Lücken in der bereitgestellten Zielzone, um erforderliche Komponenten für Ressourcenorganisation, Sicherheit, Governance, Compliance, Betrieb usw. hinzuzufügen.
...
Die Innovationsmethodik bietet Informationen zu gängigen Tools und Produktverwaltungsmethoden für Innovationen in der Cloud. Im Anschluss finden Sie einige hilfreiche erste Schritte für diesen Ansatz.
...
- [Bewährte Methoden für Innovationen](../innovate/best-practices/index.md): Hier erfahren Sie, wie Sie Azure-Dienste miteinander kombinieren, um eine Toolkette für digitale Innovationen zu erstellen.
...
Das Cloud Adoption Framework ist eine Lebenszykluslösung. Es kann Ihnen aber nicht nur dabei helfen, mit der Entwicklung von Innovationen zu beginnen, sondern auch dazu beitragen, die Entwicklung der Teams voranzutreiben, die die Innovationsbestrebungen unterstützen. Die folgenden Teams können die nächsten Schritte ausführen, um ihre Anstrengungen noch weiter zu optimieren. Diese parallelen Prozesse sind nicht linear und sollten nicht als Hindernisse betrachtet werden. Stattdessen handelt es sich jeweils um einen parallelen Wertstrom, der dazu beiträgt, die allgemeine Bereitschaft Ihres Unternehmens für die Cloud zu verbessern.

| Team | Nächste Iteration |
|---|---|
| Cloudeinführungsteam&nbsp;&nbsp; | [Prozessverbesserungen](../innovate/considerations/index.md) bietet Einblicke in die Ansätze zur Bereitstellung von Innovationen, die für Kunden relevant sind und die Einführung attraktiv machen. |
| Cloudstrategieteam&nbsp;&nbsp; | Die [Strategiemethodik](../strategy/index.md) und die [Planungsmethodik](../plan/index.md) sind iterative Prozesse, die sich mit dem Einführungsplan weiterentwickeln. Kehren Sie zu diesen Übersichtsseiten zurück, und verfolgen Sie Ihre geschäftlichen und technischen Strategien weiter. |
