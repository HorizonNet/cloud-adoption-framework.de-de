...
Einen Überblick über die empfohlenen RBAC-Methoden als Teil einer Identitäts- und Sicherheitsstrategie finden Sie unter [Verwenden der rollenbasierten Zugriffssteuerung](/azure/security/fundamentals/identity-management-best-practices#use-role-based-access-control).
