...
description: Hier finden Sie Informationen zur Verwendung von Azure-Features und -Diensten durch Umkreisnetzwerke (Demilitarized Zones, DMZs).
author: tracsman
ms.author: jonor
ms.date: 05/10/2019
ms.topic: guide
