...
Cloudeinführung ist die *Vorgehensweise*, um den Geschäftswert zu realisieren. Beim Betriebsmodell geht es darum, *wer wir sind*, bzw. um den alltäglichen Betrieb während der Cloudeinführungsphase.
...
Fahren Sie mit dem nächsten Abschnitt des Cloud Adoption Framework fort. Hier finden Sie Informationen zu Landezonen – den Grundbausteinen jeder Cloudeinführungsumgebung.

> [!div class="nextstepaction"]
> [Verwenden des Betriebsmodells](../ready/landing-zone/index.md)
